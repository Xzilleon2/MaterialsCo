...
if ($_SERVER['REQUEST_METHOD'] === "POST" && isset($_POST['action'])) {
    ...
    try {
        ...
        if ($status === 'Approved') {
            // Check if distribution already exists for this reservation
            $checkQuery = 'SELECT DISTRIBUTION_ID FROM distribution WHERE RESERVATION_ID = ?';
            ...
            if ($checkStmt->num_rows === 0) {
                ...
                $location = "Auto-generated from approved reservation";
