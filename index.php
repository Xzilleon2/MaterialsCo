<body>
    ...
    <div id="BodyDiv" class="w-full h-full  bg-gray-500 flex">
            ...
            <div class="w-2/3 h-full bg-gray-100 flex items-center justify-center">
                ...
                <!--SignIn form-->
                <div id="SignInForm" class="w-md h-120 border rounded-md shadow-md bg-white flex flex-col items-center text-center p-10 ">
                    ...
                    <form class="text-start w-full" action="">
                        ...
                        <input class="rounded-md w-full h-10 my-2 text-white bg-gray-700 hover:cursor-pointer" type="submit">
                    </form>
                    <p class="my-2">Doesn't have an account yet? <button id="showSignUp" class="text-blue-800 hover:cursor-pointer" >Create Now!</button></p>
                </div>

                <!--SignUp form-->
                <div id="SignUpForm" class="hidden w-md h-120 border rounded-md shadow-md bg-white flex flex-col items-center text-center p-10 ">
                    ...
                    <form class="text-start w-full" action="">
                        ...
                        <p class="my-2">Already got an account? <button id="showSignIn" class="text-blue-800 hover:cursor-pointer">Sign-In!</button></p>
                </div>
